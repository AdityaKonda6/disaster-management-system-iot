    ...
    <div class="container-fluid">
      <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
          <h4 class="page-title">Add Help-Center</h4>
        </div>
      </div>
        ...
        <div class="col-md-12">
          <div class="white-box">
            <div class="row">
              ...
              <div class="col-md-12">
                <form class="form-material form-horizontal" action="add_help_back.php" method="POST" enctype="multipart/form-data" onsubmit="validateform()">
                  ...
                  <div class="form-group">
                    <div class="col-md-2">
                      <label for="event_title">Officer's Number<span class="text-danger">*</span></label>
                    </div>
                    <div class="col-md-3">
