   ...
   <form class="form-material form-horizontal" action="add_back.php" method="POST" enctype="multipart/form-data" onsubmit="validateform()" >
      ...
      <div class="form-group">
            ...
            <label for="event_title">Name<span class="text-danger">*</span></label></div>
                <div class="col-md-3">
                   <input type="text" class="form-control" id="name" name="name"  placeholder="Entre Name" required  ><br>
                </div>
      </div>
      ...
      <div class="form-group">
            ...
            <label for="event_title">Password<span class="text-danger">*</span></label></div>
                <div class="col-md-3">
                   <input type="text" class="form-control" id="pass" name="pass"  required  ><br>
                </div>      
      </div>
          ...
          <div class="form-group">
            <div class="col-md-2">
            <label for="event_title">Relative's Number<span class="text-danger">*</span></label></div>
                <div class="col-md-3">
                   <input type="number" class="form-control" id="r_number" name="r_number" minlength="9" maxlength="10" required  ><br>
                </div>
      </div>
