    ...
    <div class="container-fluid">
      <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
          <h4 class="page-title">All Police station list</h4>
        </div>
        <!-- /.col-lg-12 -->
      </div>
      <!-- .row -->
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title">All Police station list</h4>
                  </div>
...
<?php
       $query = "SELECT * FROM `police` WHERE 1";
    ...
    <div class="btn-group m-r-12">
      <button aria-expanded="false" data-toggle="dropdown" class="btn btn-info dropdown-toggle waves-effect waves-light" type="button">Options <span class="caret"></span></button>
       ...
       <ul role="menu" class="dropdown-menu">    
        ...
        <li><a href="delete_police.php?id=<?php echo $row3['id'];?>">Delete</a>
