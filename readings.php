    ...
    <div class="container-fluid">
      <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
          <h4 class="page-title">All data</h4>
        </div>
        <!-- /.col-lg-12 -->
      </div>
      <!-- .row -->
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title">All Location list</h4>
                  </div>
...
<?php
       $query = "SELECT * FROM `param` WHERE user_id = '$user_id'";
       $result = mysqli_query($link,$query);
                  ...
                  while( $row3 = mysqli_fetch_assoc( $result ) )
                      {
                        ...
                        echo"<tr><td>{$row3['hr']}</td>";
                        echo"<td>{$row3['temp']}</td>";
                        echo"<td>{$date}</td>";
    ...
    <div class="btn-group m-r-12">
      <button aria-expanded="false" data-toggle="dropdown" class="btn btn-info dropdown-toggle waves-effect waves-light" type="button">Options <span class="caret"></span></button>
       ...
       <ul role="menu" class="dropdown-menu">
        ...
        <li><a href="delete_location.php?id=<?php echo $row3['id'];?>">Delete</a>
